...
def memorize_list(key: str, value: str, tool_context: Context):
    """
...
def memorize(key: str, value: str, tool_context: Context):
    """
...
def forget(key: str, value: str, tool_context: Context):
    """
...
def _load_precreated_itinerary(callback_context: Context):
    """
