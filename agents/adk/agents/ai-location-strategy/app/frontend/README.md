...
```bash
# From ai-location-strategy directory
...
```bash
# From the ai-location-strategy directory
...
```bash
# In a new terminal, from ai-location-strategy directory
cd app/frontend
...
2. Verify agent name matches: `"ai_location_strategy"`
